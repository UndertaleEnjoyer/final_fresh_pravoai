...
export default function Index() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Все планы включают поддержку. Профессиональный и Корпоративный планы предоставляют приоритетную и 24/7 поддержку соответственно.",
    },
    {
      ...
      <main className="flex-1">
        ...
        <section className="container py-20 md:py-32 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Присоединитесь к тысячам профессионалов, использующих LegalAI для мгновенной юридической консультации
          </p>
          <Link
            to="/auth"
            className="inline-block px-8 py-3 rounded-lg bg-accent text-accent-foreground font-semibold hover:opacity-90 transition-opacity"
          >
            Начните свою бесплатную консультацию сегодня
          </Link>
        </section>
      </main>
